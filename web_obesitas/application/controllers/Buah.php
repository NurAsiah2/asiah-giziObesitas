...
class Buah extends CI_Controller
{
    ...
    //method defauld
    {
        $this->load->model('Buah_Model', 'buah');
        ...
        //config
        $config['base_url'] = 'http://localhost/web_obesitas/buah/index';
        ...
        $data['buah'] = $this->buah->getBuah($config['per_page'], $data['start']);


        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar');
        $this->load->view('templates/topbar');
        $this->load->view('buah/buah');
    ...
    {
        $data['title'] = 'Form Tambah Data Buah';
        $data['user'] = $this->db->get_where('user', ['email' =>
        $this->session->userdata('email')])->row_array();
    ...
    {
        $data['title'] = 'Form Ubah Data Buah';
        $data['user'] = $this->db->get_where('user', ['email' =>
        $this->session->userdata('email')])->row_array();
